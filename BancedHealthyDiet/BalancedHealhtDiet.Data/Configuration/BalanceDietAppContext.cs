    ...
    public class BalanceDietAppContext:DbContext
    {
       ...
       // public DbSet<Nutrition> Nutritions { get; set; }
        ...
        public BalanceDietAppContext() : base("DefaultConnection")
        {
            ...
            //this.Products.AddRange(new List<Product> { product1, product2, product3, product4, product5, product6 });
            //this.SaveChanges();
        }
        private void InitializeDatabase()
        {
            ...
            //this.Categories.AddRange(new List<Category> { category1, category2, category3, category4, category5, category6, category7, category8, category9, category10, category11 });
            //this.SaveChanges();
            ...
            //this.Ingredients.AddRange(new List<Ingredient> { ingr1, ingr2, ingr3, ingr4, ingr5, ingr6, ing7 });
            //this.SaveChanges();
            ...
            //this.RecipeImages.AddRange(new List<RecipeImage> { recipeImage1, recipeImage2, recipeImage3, recipeImage4, recipeImage5, recipeImage6, recipeImage7, recipeImage8 });
            ...
            ////Database.SetInitializer<BalanceDietAppContext>(new ContextInitializator());
            ////if (!Database.Exists())
            ////{
