...
namespace BancedHealthyDiet.Models
{
    internal class DataIntializator
    {
        ...
        internal void InitWithData(DataSet dataSet)
        {
            ...
            dataSet.Products.AddRange(new List<Product> { product1, product2, product3, product4, product5, product6, product7 });
            ...
            dataSet.Recipes.Add(recipe);
            dataSet.Recipes.Add(recipe2);
        }
    }
}